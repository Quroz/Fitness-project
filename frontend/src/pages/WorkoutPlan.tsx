    ...
    <div className='w-full h-screen relative px-24 flex justify-center items-center'>
         ...
         <div className='h-[90%] w-[50%] absolute z-10 flex flex-col'>
            ...
            <div className='w-full h-[85%] overflow-y-auto flex flex-col gap-8 pt-8'>
                <div className='flex items-center justify-around rounded-lg bg-gray-200 max-w-full py-4 mx-2 hover:bg-gray-100 cursor-pointer opacity-80'>
            ...
            <div className='w-full flex items-center justify-around justify flex-1'>
                <button className= 'w-10 h-10 bg-gray-200 text-xl hover:bg-orange-100 rounded-md opacity-80' onClick={() => {alert('clicked'); }}>+</button>
                <button className= 'w-40 h-10 bg-gray-200 hover:bg-orange-100 rounded-md opacity-80' onClick={() => {alert('clicked'); }}>Add day</button>
            </div>
         </div>
    </div>
  )
