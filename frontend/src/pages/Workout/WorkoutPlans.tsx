		...
		<div className="mt-24 w-[80%] mx-auto">
			...
			<div className="flex flex-col w-full gap-4 my-8 overflow-y-auto">
				{workoutDays.map((item: WorkoutDay, index: number) => (
					<div
						className="flex items-center justify-around max-w-full py-4 bg-white border-[1px] border-gray-300 rounded-md"
						key={index}
					>
						<div
						...
						<div className="flex items-center gap-4 top-4 right-2">
							<button
