	...
	return (
		<div className="relative w-full h-screen">
			<div className="h-[70px] bg-black w-full absolute top-0 left-0 z-10 flex items-center justify-between">
				<img src={logo} className="object-cover ml-8 rounded-full w-14 h-14" />
				<div className="flex items-center gap-8 mr-8">
					<button className="px-5 py-2 text-sm font-bold text-black bg-green-400 rounded-full hover:bg-green-200">
						About
					</button>
					<button className="px-5 py-2 text-sm font-bold text-black bg-orange-400 rounded-full hover:bg-orange-200">
						Membership
					</button>
				</div>
			</div>
